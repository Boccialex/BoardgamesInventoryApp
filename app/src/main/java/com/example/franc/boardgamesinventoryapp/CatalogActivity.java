...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup FAB to open the Add Game Activity
        ...
        gameListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // Form the content URI that represents the specific game data that was clicked on,
                // by appending the "id" (passed as input to this method) onto the
                // {@link GamesEntry#CONTENT_URI}.
                Uri currentGameUri = ContentUris.withAppendedId(GamesEntry.CONTENT_URI, id);
    ...
    private void insertGame() {
        ...
        // and Dixit game's attributes are the values.
        ContentValues values = new ContentValues();
        values.put(GamesEntry.COLUMN_GAME_TITLE, "Dixit");
        values.put(GamesEntry.COLUMN_GAME_CATEGORY, GamesEntry.CATEGORY_PARTY_GAME);
        values.put(GamesEntry.COLUMN_GAME_PRICE, 25);
        values.put(GamesEntry.COLUMN_GAME_QUANTITY, 7);
        values.put(GamesEntry.COLUMN_GAME_SUPPLIER_NAME, "Spartaco");
        values.put(GamesEntry.COLUMN_GAME_SUPPLIER_PHONE_NUMBER, "+39 328 8724567");

        // Insert a new row for Dixit into the provider using the ContentResolver.
        // Use the {@link GamesEntry#CONTENT_URI} to indicate that we want to insert
        // into the games database table.
        // Receive the new content URI that will allow us to access the game's data in the future.
    ...
    private void deleteAllGames() {
        int rowsDeleted = getContentResolver().delete(GamesEntry.CONTENT_URI, null, null);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                GamesEntry.CONTENT_URI,   // Provider content URI to query
